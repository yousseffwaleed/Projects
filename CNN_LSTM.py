...
model = create_lstm_model(input_shape=(1350, 10))
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', xticklabels=["10 BPM", "15 BPM", "20 BPM", "No Breathing", "Empty Room"], yticklabels=["10 BPM", "15 BPM", "20 BPM", "No Breathing", "Empty Room"])
...
#         ax.imshow(X_test_resized[idx].squeeze().T, aspect='auto', cmap='viridis')
